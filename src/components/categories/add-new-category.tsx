...
import { AddNewCategory } from "@/actions/add-food/AddNewCategory.action";
...
const AddNewCategoryDialog = ({ children }: { children: React.ReactNode }) => {
  const form = useForm<z.infer<typeof addNewCategoryFormSchema>>({
  ...
  async function onSubmit(values: z.infer<typeof addNewCategoryFormSchema>) {
    setLoading(true);
    ...
    try {
      ...
      const response = await AddNewCategory(dataToBeSent);
            ...
            <section className="grid justify-start">
              {imagePreview && (
                <div className="flex flex-col items-center">
                  <div className="bg-green-800 w-full sm:w-80 h-36 overflow-hidden rounded-lg">
                    <Image
                      width={200}
                      height={200}
