...
export function RestaurantPanelDataTable<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between mb-4">
        <div className="flex items-center gap-10">
          <div className="flex justify-center border-2 items-center max-w-sm md:min-w-96 px-5 bg-[#fff] text-black h-12 rounded-full group focus-within:ring-2 focus-within:ring-[#657eff]">
            ...
            <Input
              placeholder="Search by Id, Restaurant Name & Address"
              value={globalFilter}
      ...
      <div className="overflow-x-scroll rounded-none border">
